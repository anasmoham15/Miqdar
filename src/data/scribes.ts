...
// The Scribes of the Prophet ﷺ — the Companions who wrote down the Qur'an as it was
// revealed and who wrote the Prophet's letters to kings, tribes and governors.
// Sources: al-Bukhari, Muslim, Ibn Sa'd's Tabaqat, al-Dhahabi's Siyar A'lam al-Nubala,
// Ibn Hajar's al-Isabah, al-Suyuti's al-Itqan fi 'Ulum al-Qur'an.
export const scribesStories: Story[] = [
  {
    id: "scribes-zayd-ibn-thabit",
    title: "Zayd ibn Thabit (RA) — Scribe of Revelation, Compiler of the Qur'an",
    description:
      "Began writing revelation as a teenager in Madinah, learned Hebrew and Syriac for the Prophet ﷺ, and twice compiled the entire Qur'an into one written codex.",
    category: "Scribes",
    readTime: "9 min",
    sections: {
      intro: p(
        "Zayd ibn Thabit al-Ansari was from the Khazraj clan of Banu Najjar in Madinah. He was eleven years old at the Hijrah. He had memorised parts of the Qur'an as a child even before the Prophet ﷺ arrived, and his memory and intelligence stood out from the start.",
        "When the Prophet ﷺ entered Madinah, Zayd was brought before him. The Prophet ﷺ admired his intelligence and asked him to learn the language of the Jews so the Prophet ﷺ would have a trusted Muslim reader and writer of their letters. Zayd later said: 'I learned it for him in less than a fortnight.' He also learned Syriac for the same purpose.",
        "His character combined a sharp mind with humility, deep precision, and an unbroken devotion to the Prophet ﷺ. He grew up to be one of the most respected scholars of the Companions — a master of Qur'an, a master of fara'id (inheritance law), a master of fatwa.",
      ),
      life: p(
        "Zayd asked permission to fight at Badr; the Prophet ﷺ sent him back because of his age. He asked again at Uhud and was again sent back. He was finally accepted at the Battle of the Trench. From that point onward he was constantly with the Prophet ﷺ as a scribe.",
        "He was one of the central scribes of revelation. Whenever a verse was revealed, Zayd would often be the one called: 'Bring the writing materials, the pen and the parchment.' He wrote the verses on whatever surface was available — date palm stalks, thin white stones, shoulder bones of camels, leather. He memorised what he wrote, and the Prophet ﷺ would have him recite it back.",
        "He also wrote the Prophet's letters — to allies, to tribes, to officials, to communities. His Hebrew enabled him to read incoming Jewish correspondence and to reply in their tongue, ensuring no message could be twisted.",
        "When the Prophet ﷺ passed away, the Qur'an was preserved in two ways: in the chests of the huffaz, and on scattered written materials in the homes of the scribes. Then came the Battle of Yamamah against Musaylimah the Liar in 12 AH, in which around seventy huffaz were martyred. 'Umar went to Abu Bakr in alarm: 'I fear that battles will keep killing the huffaz, and a great part of the Qur'an will be lost. Compile the Qur'an into one written volume.'",
        "Abu Bakr summoned Zayd ibn Thabit. Zayd said: 'By Allah, if they had asked me to move a mountain, it would not have been heavier upon me than this command.' He set to work with rigorous standards: every verse had to be confirmed by two independent witnesses — one from memory, one from a written record made in the presence of the Prophet ﷺ. He gathered every fragment, cross-checked it, and produced the first single mushaf, which was kept first by Abu Bakr, then 'Umar, then Hafsah bint 'Umar.",
        "About twenty years later, the Muslims of Sham, Iraq and Yemen began differing in recitation, and some quarrels broke out about whose recitation was correct. Hudhayfah ibn al-Yaman raced back to Madinah and warned 'Uthman: 'O Commander of the Believers, save this Ummah before they differ over the Book like the Jews and Christians differed over theirs.' 'Uthman called Zayd ibn Thabit again — together with three other Qurayshi Companions — and instructed them to make official copies from Hafsah's mushaf, sending one copy to each major centre and ordering all variant private texts burned.",
        "Zayd led the project. The Mushaf 'Uthmani — the script and ordering used by every printed Qur'an in the world today — is fundamentally his work, twice over.",
        "He continued teaching Qur'an, fara'id, and fatwa in Madinah for the rest of his life. Companions and Tabi'in came to him for inheritance rulings — the Prophet ﷺ himself had said: 'The most knowledgeable of you in fara'id is Zayd.' He died in Madinah around 45 AH (some say 51 AH). On the day of his death Ibn 'Abbas said: 'Today a great deal of knowledge has been buried.'",
      ),
      legacy: p(
        "Zayd ibn Thabit is, after Abu Bakr and 'Umar, the most directly responsible human being for the preservation of the Qur'an as a written document. Every printed mushaf in the world traces back through his careful, witness-by-witness compilation.",
        "Ibn Hajar and al-Dhahabi both highlight his standard of two-witness verification as the foundation of Islam's unbroken textual chain. He treated every single verse as a trust before Allah.",
        "He was also the scholar the Companions sent people to for inheritance rulings — a discipline that requires precision, fractions, and total seriousness. The same character that made him the perfect compiler made him the perfect faqih of fara'id.",
      ),
      keyFacts: [
        "Born in Madinah; eleven years old at the Hijrah",
        "Learned Hebrew in less than a fortnight at the Prophet's instruction",
        "Wrote both Qur'anic revelation and the Prophet's letters",
        "Compiled the first complete written mushaf under Abu Bakr",
        "Led 'Uthman's standardisation project that produced the official Mushaf",
        "The Prophet ﷺ called him the most knowledgeable in fara'id",
        "Died in Madinah around 45–51 AH; Ibn 'Abbas said 'a great deal of knowledge was buried today'",
      ],
      lessons: p(
        "Begin serving the Deen young. Zayd was a teenager when he became a scribe of revelation. There is no minimum age for being useful to Islam.",
        "Learn the languages of the people you must reach. Zayd learned Hebrew and Syriac for the Prophet ﷺ. Whether it is Arabic, English, or the language of your local non-Muslims, language is a tool of da'wah.",
        "Treat the Book of Allah as a trust. Zayd's two-witness rule should shape how casually we treat what we share online about the Qur'an. Verify before you spread.",
        "Heavy responsibilities feel like mountains — and you carry them anyway. Zayd was overwhelmed at Abu Bakr's command, but he obeyed. The mountain only feels heavy because it is honourable.",
        "Specialise in something the Ummah will need after you. Zayd specialised in Qur'an and fara'id. Choose a discipline of the Deen and become a reference in it.",
      ),
    },
  },
  {
    id: "scribes-muawiyah-ibn-abi-sufyan",
    title: "Mu'awiyah ibn Abi Sufyan (RA) — Scribe of the Prophet, Founder of the Umayyad State",
    description:
      "After the Conquest of Makkah, the Prophet ﷺ chose him as one of his scribes — and he went on to become governor of Sham for forty years and the first Caliph of the Umayyad era.",
    category: "Scribes",
    readTime: "8 min",
    sections: {
      intro: p(
        "Mu'awiyah ibn Abi Sufyan ibn Harb was a Qurayshi noble from Banu Umayyah. He embraced Islam at the Conquest of Makkah in 8 AH, together with his father and many of the Quraysh leadership.",
        "Although his Islam came late, his sincerity, intelligence, political mind and beautiful handwriting were quickly recognised by the Prophet ﷺ. He was made one of the official scribes — kuttab — of the Messenger of Allah, recording correspondence and treaties.",
        "He grew into a man of immense political ability — patient, steady, deeply read in Arab tribal politics, and notable for his hilm (forbearance). He once said: 'I do not insert my sword where my whip will do, nor my whip where my tongue will do, nor my tongue where my smile will do.'",
      ),
      life: p(
        "After the Prophet ﷺ passed away, Abu Bakr sent armies to Sham. Mu'awiyah went with his brother Yazid ibn Abi Sufyan as part of the campaign. When Yazid died of plague at 'Amwas in 18 AH, 'Umar appointed Mu'awiyah governor of Damascus. 'Uthman extended his governorship over all of Sham.",
        "He governed Sham for around twenty years under 'Umar and 'Uthman, then ruled it as an independent power during the conflict with 'Ali, then became Caliph himself in 41 AH when al-Hasan ibn 'Ali made the historic agreement with him to unify the Ummah and end the civil war. The Prophet ﷺ had foretold that moment: 'Verily, this son of mine is a sayyid (master), and Allah will reconcile through him two great groups of Muslims.' (Bukhari)",
        "Under Mu'awiyah's rule, the Muslim state stabilised and expanded. The first Muslim navy was built and won decisive battles in the Mediterranean. Constantinople was besieged for the first time. Sham, Egypt, North Africa, Iraq and Persia were welded into a functioning administrative system that drew on the best of Roman and Persian methods. He moved the capital to Damascus, founded the Umayyad state, and ruled until his death in 60 AH.",
        "Throughout his life he carried himself as a scribe of revelation. He never claimed superiority over the Companions of Badr or Bay'at al-Ridwan. He used to say of his scribal role: 'The Messenger of Allah ﷺ entrusted me with his revelation; I wrote what he dictated. By Allah, that is enough honour for me.' Ibn 'Abbas, asked once if Mu'awiyah understood fiqh, answered simply: 'Yes — he is a faqih.' (Bukhari)",
        "He narrated 163 hadiths from the Prophet ﷺ. He kept Friday khutbahs short, ruled with hilm, gave openly to anyone who asked, and the historians remember his time as a period of relative ease compared to what came before and after.",
        "His reign also included grave decisions that scholars have always discussed and analysed — including the appointment of his son Yazid as his successor, which broke the consultative pattern of the Rashidun. The Companions disagreed on this in his own time, and the Ummah has continued to discuss it. The classical position of Ahl al-Sunnah, articulated by scholars like al-Dhahabi and Ibn Taymiyyah, is to remember Mu'awiyah's status as a Sahabi and a scribe of the Prophet ﷺ, to defend his honour, while not making any Companion infallible.",
      ),
      legacy: p(
        "Mu'awiyah ibn Abi Sufyan is one of the most consequential figures in Islamic history. He is one of the recorded scribes of the Prophet ﷺ, the first Caliph of the Umayyad dynasty, the unifier of the Ummah after the first civil war, and the architect of the first organised Muslim navy.",
        "Ahl al-Sunnah honours him as a Companion. Imam Ahmad said: 'Whoever insults the Companions of the Prophet ﷺ — including Mu'awiyah — is an innovator and a deviant.' That position is rooted in clear evidence: he saw the Prophet ﷺ, believed in him, served him as a scribe, and the Prophet ﷺ supplicated for him: 'O Allah, make him a guide, well-guided, and guide others through him.' (Tirmidhi)",
        "His political career carries lessons for both rulers and ruled. His hilm and patience are studied as models of statesmanship; his more contested decisions are studied as warnings about how power, even in the hands of a Sahabi, can shape the future of an Ummah for centuries.",
      ),
      keyFacts: [
        "From the Qurayshi clan of Banu Umayyah; embraced Islam at the Conquest of Makkah",
        "Chosen by the Prophet ﷺ as one of his scribes",
        "Governor of Sham for around twenty years under 'Umar and 'Uthman",
        "Became Caliph in 41 AH after al-Hasan's reconciliation",
        "Founded the Umayyad dynasty with its capital at Damascus",
        "Built the first Muslim navy and besieged Constantinople for the first time",
        "Narrated 163 hadiths from the Prophet ﷺ",
        "Died in 60 AH",
      ],
      lessons: p(
        "Late entry into Islam does not block greatness. Mu'awiyah's Islam came after years of opposition, yet the Prophet ﷺ entrusted him with revelation. Never write off a person — or yourself — for a slow start.",
        "Hilm is a ruler's most underrated quality. 'I do not insert my sword where my whip will do.' Patience and proportion preserve states and families.",
        "Honour the scribes of revelation. Whatever any human's later disagreements, those who served the Prophet ﷺ in his lifetime have a sanctity that Ahl al-Sunnah preserves.",
        "Power amplifies decisions for centuries. Some of his choices reshaped the Ummah for hundreds of years. Take seriously every authority Allah gives you — even over a small team or family.",
        "Speak well of the Companions. Imam Ahmad's standard is the Sunnah: defend their honour, study their lives, learn from their decisions, and leave their final accounts to Allah.",
      ),
    },
  },
  {
    id: "scribes-ubayy-ibn-kab",
    title: "Ubayy ibn Ka'b (RA) — Master Reciter and Scribe of the Qur'an",
    description:
      "Called by the Prophet ﷺ 'the master reciter of my Ummah' — Allah Himself ordered the Prophet to recite Surah al-Bayyinah to him.",
    category: "Scribes",
    readTime: "7 min",
    sections: {
      intro: p(
        "Ubayy ibn Ka'b al-Ansari was from the Khazraj clan of Banu Najjar in Madinah. He was one of the Ansar who took the Second Pledge of al-'Aqabah, and he embraced Islam early, before the Hijrah.",
        "He could read and write at a time when literacy in Arabia was rare. As soon as the Prophet ﷺ arrived in Madinah, Ubayy became one of his trusted scribes — recording revelation, writing his letters, and serving the Prophet ﷺ in correspondence.",
        "His character was earnest, watchful, and intensely focused on the Qur'an. The Prophet ﷺ said of him: 'The most learned of my Ummah in halal and haram is Mu'adh ibn Jabal, and the most learned of my Ummah in reciting the Qur'an is Ubayy ibn Ka'b.' (Tirmidhi)",
      ),
      life: p(
        "Ubayy attended Badr, Uhud, the Trench, and every major engagement with the Prophet ﷺ. But his deepest service was to the Qur'an. He memorised it as it was revealed, wrote it down, and recited it back to the Prophet ﷺ for verification.",
        "Two famous events sealed his place. First, the Prophet ﷺ said to him one day: 'Allah has commanded me to recite to you Surah al-Bayyinah.' Ubayy said, with tears: 'Did Allah mention me by name?' The Prophet ﷺ said: 'Yes.' Ubayy wept openly. (Bukhari, Muslim)",
        "Second, the Prophet ﷺ asked him: 'O Abu al-Mundhir, do you know which verse of the Book of Allah you have with you is the greatest?' Ubayy answered: 'Allah and His Messenger know best.' The Prophet ﷺ repeated the question. Ubayy answered: 'Ayat al-Kursi.' The Prophet ﷺ struck him on the chest with affection and said: 'May knowledge be easy for you, O Abu al-Mundhir.' (Muslim)",
        "When Abu Bakr ordered Zayd ibn Thabit to compile the Qur'an into one mushaf, Zayd worked closely with Ubayy and other major reciters and scribes to verify every verse. Ubayy's recitation and his written record were among the principal references.",
        "When 'Uthman commissioned the standardised mushaf, Ubayy was again consulted as one of the senior reciters of the Ummah. The committee verified its readings against his recitation among others.",
        "He continued teaching Qur'an in Madinah, leading taraweeh during 'Umar's caliphate when 'Umar gathered the people behind one imam, and producing a generation of students. He died in Madinah; the strongest reports place his death around 30 AH during 'Uthman's caliphate.",
      ),
      legacy: p(
        "Ubayy ibn Ka'b is one of the four Companions who, the Prophet ﷺ instructed, the Qur'an should be learned from: 'Take the Qur'an from four — from 'Abdullah ibn Mas'ud, Salim mawla Abi Hudhayfah, Mu'adh ibn Jabal, and Ubayy ibn Ka'b.' (Bukhari)",
        "His chains of recitation feed into the major schools of qira'at known to the Ummah today. Every Muslim who recites the Qur'an in any of the canonical readings is connected back, through teacher after teacher, to Companions like Ubayy.",
        "His weeping at hearing his name on the Prophet's lips — 'did Allah mention me by name?' — is one of the most moving glimpses we have of how the Companions revered the speech of Allah.",
      ),
      keyFacts: [
        "Ansari from Banu Najjar; took the Second Pledge of al-'Aqabah",
        "One of the Prophet's scribes of revelation and correspondence",
        "Allah commanded the Prophet ﷺ to recite Surah al-Bayyinah to him by name",
        "Said by the Prophet ﷺ to be the best reciter of the Ummah",
        "Worked with Zayd on the first compilation under Abu Bakr",
        "Consulted in the standardisation under 'Uthman",
        "Led taraweeh in Madinah during 'Umar's caliphate",
        "Died in Madinah around 30 AH",
      ],
      lessons: p(
        "Make the Qur'an your speciality. Ubayy is remembered for one thing above all else: he was the Qur'an's man. Pick the discipline you will be remembered for, and pour your life into it.",
        "Tears at hearing your name in front of Allah. Ubayy wept when the Prophet ﷺ said Allah had named him. Live so that the idea of Allah mentioning you moves you to tears, not to pride.",
        "Memorisation is not enough — recite to a teacher. Even Ubayy recited back to the Prophet ﷺ. Find a qualified teacher and recite to them.",
        "Stand behind one imam. 'Umar's reform — gathering taraweeh behind one imam led by Ubayy — is a lesson in the value of unity in worship.",
        "Honour the early Ansar. Many of the scribes were from Madinah's Ansar. Their service to the Qur'an is part of the wider service of the city of the Prophet ﷺ to Islam.",
      ),
    },
  },
  {
    id: "scribes-abdullah-ibn-masud",
    title: "'Abdullah ibn Mas'ud (RA) — The First Reciter, the Walking Mushaf",
    description:
      "The shepherd boy who became one of the four the Prophet ﷺ named as Qur'an teachers — and the first to recite the Qur'an aloud in front of Quraysh.",
    category: "Scribes",
    readTime: "8 min",
    sections: {
      intro: p(
        "'Abdullah ibn Mas'ud al-Hudhali was a thin, short young shepherd in Makkah, working for 'Uqbah ibn Abi Mu'ayt, when he met the Prophet ﷺ. He was among the very first to embrace Islam — counted by the historians among the first six or seven.",
        "Although he is most famous as a reciter, exegete and faqih rather than as one of the formal kuttab al-wahy, he is rightly grouped with the Scribes here because of his unmatched role in transmitting and recording the Qur'an. He is one of the four named by the Prophet ﷺ as those from whom the Qur'an should be learned, and his personal mushaf was one of the great references of the early Companions.",
        "His character was small in body, large in faith — and the Prophet ﷺ said of his thin legs: 'They are heavier in the scale than the mountain of Uhud.' (Ahmad)",
      ),
      life: p(
        "When the Companions were still few and weak in Makkah and no one dared recite the Qur'an aloud at the Ka'bah, Ibn Mas'ud said: 'I will recite it to them.' The Companions warned him: 'They will hurt you.' He said: 'Allah will protect me.' He went to the Maqam, raised his voice, and recited Surah al-Rahman in front of Quraysh. They beat him until his face bled. He returned to the Companions, and when they expressed sorrow, he said: 'By Allah, the enemies of Allah have never been more humiliated in my eyes than today. If you wish, I will go again tomorrow.' They begged him not to.",
        "He became one of the closest servants of the Prophet ﷺ. He carried his sandals, his miswak, his cushion, his water for wudu. He was so often inside the Prophet's house that some thought he was from his family. The Prophet ﷺ taught him directly, surah by surah, and he was the first man to memorise seventy surahs from the Prophet's own mouth before anyone else.",
        "The Prophet ﷺ said: 'Whoever wishes to recite the Qur'an as fresh as the day it was revealed, let him recite it according to the recitation of Ibn Umm 'Abd' — meaning Ibn Mas'ud. (Ahmad, Ibn Majah)",
        "After the Prophet's death, 'Umar sent him to Kufa as a teacher and judge, writing: 'I have sent you 'Abdullah ibn Mas'ud, and I have preferred you over myself by him — so take from him.' He taught a generation of Tabi'in, including 'Alqamah, al-Aswad, Masruq, and many of the early imams of Kufa whose chains feed into Imam Abu Hanifah.",
        "He kept his own personal written mushaf — one of the major recensions of the Qur'an as preserved by the Companions. When 'Uthman ordered standardisation, the order included that all variant private texts be brought in and burned to preserve the Ummah's unity around one official text. Ibn Mas'ud was initially deeply reluctant; he loved his mushaf and was protective of his role. There were tense words. Eventually he submitted to the rightly guided Caliph and the consensus of the senior Companions, and the mushaf was returned. Scholars like al-Dhahabi note that his initial reluctance was based on the soundness of his personal record, not on rebellion — and that he ultimately accepted the official mushaf.",
        "He returned to Madinah at the end of his life. He died around 32 AH and was buried in al-Baqi'. 'Uthman led his janazah.",
      ),
      legacy: p(
        "Ibn Mas'ud's place in the science of Qur'an is foundational. The chains of recitation, tafsir and fiqh of Kufa — and through Kufa much of the school of Imam Abu Hanifah — pass through him. He is one of the four Qur'an teachers the Prophet ﷺ named, and his exegesis is quoted on nearly every page of the major tafsirs.",
        "His Islam at the Ka'bah, when he recited Surah al-Rahman in front of the bullies of Quraysh, is one of the most courageous moments of early Makkan Islam.",
        "His later disagreement with 'Uthman, and his final submission, are studied carefully by scholars as a model of how Companions who differed still preserved the unity of the Ummah and the authority of the Caliph.",
      ),
      keyFacts: [
        "Among the very first six or seven to embrace Islam in Makkah",
        "First Companion to recite the Qur'an aloud at the Ka'bah",
        "Carried the Prophet's personal items and was inside his house often",
        "First to memorise 70 surahs from the Prophet's mouth",
        "One of the four Qur'an teachers named by the Prophet ﷺ",
        "Sent by 'Umar to teach in Kufa; founder of its school of Qur'an and fiqh",
        "Died in Madinah around 32 AH; 'Uthman prayed his janazah",
      ],
      lessons: p(
        "Allah honours the small. Ibn Mas'ud was thin, short, and a former shepherd. The Prophet ﷺ weighed his thin legs against Uhud and said they were heavier. Never measure people by their appearance.",
        "Be the first to do the hard thing for Islam. Recite when others are silent. Speak the truth when others fear. Walk when others sit.",
        "Closeness to the Prophet ﷺ is closeness to the Sunnah. Live with the Sunnah daily — wudu, miswak, dhikr, prayer — and you live near him.",
        "Even disagreements among the great should end in unity. Ibn Mas'ud disagreed with the burning of his mushaf — and ultimately submitted for the sake of the Ummah. Your principles must include the principle of unity.",
        "Specialise in transmitting what you have. Ibn Mas'ud's gift to Kufa lasted centuries because he taught what he had. Pour what you know into the next generation.",
      ),
    },
  },
  {
    id: "scribes-ali-ibn-abi-talib",
    title: "'Ali ibn Abi Talib (RA) — Scribe of the Treaty, Pen of the Prophet",
    description:
      "Among the youngest of the scribes, who wrote the Treaty of Hudaybiyah with his own hand and many of the Prophet's most sensitive letters.",
    category: "Scribes",
    readTime: "8 min",
    sections: {
      intro: p(
        "'Ali ibn Abi Talib, cousin of the Prophet ﷺ, raised in his household, the first child to embrace Islam, the husband of Fatimah and the father of al-Hasan and al-Husayn — a man whose virtues fill volumes.",
        "Among those many virtues, less spoken about, is his role as one of the official scribes of the Prophet ﷺ. He wrote treaties, contracts, letters and personal correspondence for the Messenger of Allah ﷺ.",
        "His character was depth itself — a man of knowledge, a man of zuhd, a man of the sword and the pen, who memorised the Qur'an, understood it deeply, and was famously eloquent in both speech and writing.",
      ),
      life: p(
        "From his earliest days as a Muslim, 'Ali was one of the small group around the Prophet ﷺ who could read and write. As Madinah's affairs grew — letters to allies, contracts with tribes, marriage and trade documents within the Muslim community, and treaties with enemies — 'Ali was repeatedly the chosen scribe.",
        "His most famous scribal moment is the Treaty of Hudaybiyah. He sat between the Prophet ﷺ and Suhayl ibn 'Amr, pen in hand. When he wrote 'Bismillah ar-Rahman ar-Rahim,' Suhayl objected. The Prophet ﷺ instructed him to change it to 'Bismika Allahumma.' When he wrote 'This is what Muhammad the Messenger of Allah has agreed,' Suhayl objected again. The Prophet ﷺ told him to erase 'Messenger of Allah.' 'Ali — devotion overflowing — said: 'O Messenger of Allah, my hand will not erase your name.' The Prophet ﷺ took the parchment and erased it himself, and 'Ali continued writing as instructed. (Bukhari)",
        "He wrote many of the Prophet's letters to chiefs, governors, and rulers. He drafted contracts that became models in Islamic law — the muddat (timed) treaties, the safety guarantees, the loan and partnership documents — many later codified by the fuqaha based on his templates.",
        "After the Prophet's death he served Abu Bakr, 'Umar and 'Uthman as one of their most trusted advisors and judges. 'Umar said: 'May Allah not let me face a problem that does not have Abu al-Hasan to solve it' — meaning 'Ali. He was famed as the best judge among the Companions; the Prophet ﷺ had said: 'The best judge among you is 'Ali.' (Ahmad)",
        "He became the fourth Caliph in 35 AH after the martyrdom of 'Uthman, in one of the most painful and turbulent periods of the early Ummah. He moved the capital to Kufa. He fought the Battle of the Camel and the Battle of Siffin. He governed under impossible conditions, with the Ummah split across Iraq, Sham and Egypt. Through all of it, his judgements, sermons, and letters — preserved in works like Nahj al-Balaghah and the major hadith collections — remained pure prophetic light, full of Qur'an, full of fear of Allah, full of advice on justice and humility.",
        "He was assassinated in the masjid of Kufa in Ramadan of 40 AH by the Khariji 'Abd al-Rahman ibn Muljam, while going out to lead Fajr. He died saying: 'Fuztu wa Rabb al-Ka'bah — I have succeeded, by the Lord of the Ka'bah.'",
      ),
      legacy: p(
        "'Ali is one of the four Rightly Guided Caliphs and one of the ten promised Paradise. His role as a scribe is a small but glowing facet of an enormous life. Every legal contract template in classical fiqh — for sales, marriage, partnerships, treaties — owes something to the prophetic letters and contracts he drafted.",
        "His scribal moment at Hudaybiyah is itself a lesson: he could not bring himself to erase the title of the Prophet ﷺ from a parchment. That kind of love for the Messenger of Allah is the standard for every Muslim writer, every Muslim teacher, every Muslim parent.",
        "Ahl al-Sunnah honours him as the fourth Caliph, the cousin and son-in-law of the Prophet ﷺ, the father of the Prophet's only surviving lineage, and one of the great teachers of the Ummah.",
      ),
      keyFacts: [
        "First child to embrace Islam, raised in the household of the Prophet ﷺ",
        "One of the official scribes of the Prophet ﷺ",
        "Wrote the Treaty of Hudaybiyah with his own hand",
        "The Prophet ﷺ said: 'The best judge among you is 'Ali'",
        "Fourth Caliph from 35 AH",
        "Father of al-Hasan and al-Husayn — the Prophet's surviving lineage",
        "Assassinated in Kufa in Ramadan, 40 AH",
      ],
      lessons: p(
        "Love your Prophet ﷺ to the point of trembling. 'Ali could not erase his name. Train your heart to revere him in every conversation, every reference, every joke you do not make.",
        "Pen and sword are both paths of service. 'Ali carried both. The Ummah needs writers as much as it needs warriors — sometimes more.",
        "Knowledge that solves problems is the best knowledge. 'Umar relied on 'Ali for the hard cases. Build the kind of fiqh that helps real people in real difficulties.",
        "Govern through fitnah with Qur'an in hand. 'Ali's caliphate was the most painful of the Rashidun. He held to Qur'an and Sunnah even when both sides claimed them. May Allah grant the Ummah such patience in our age.",
        "Die saying you have succeeded. 'Fuztu wa Rabb al-Ka'bah' — make this your dying ambition. To meet Allah on the path of His Messenger ﷺ is the only success that matters.",
      ),
    },
  },
  {
    id: "scribes-khalid-ibn-saeed",
    title: "Khalid ibn Sa'id ibn al-'As (RA) — The Forgotten Scribe and First Martyr in Sham",
    description:
      "An early convert from a hostile family who became a scribe of the Prophet ﷺ and was finally martyred carrying the standard against the Romans at Marj al-Suffar.",
    category: "Scribes",
    readTime: "6 min",
    sections: {
      intro: p(
        "Khalid ibn Sa'id ibn al-'As ibn Umayyah was a Qurayshi nobleman from Banu Umayyah — the same broad clan as 'Uthman and Mu'awiyah, but a much earlier convert. The classical sources count him among the first four or five men to embrace Islam.",
        "He could read and write — an unusual skill in early Makkah — and the Prophet ﷺ later employed him as a scribe and as a teacher of writing for the Muslims of Madinah.",
        "His character was steady, determined, and willing to bear long hardship for Islam. His own father al-As ibn Umayyah, on hearing of his conversion, beat him so severely that he left him without food or water in the Makkan heat. Khalid did not retract.",
      ),
      life: p(
        "Khalid embraced Islam after a powerful dream he saw, which the Prophet ﷺ confirmed for him. His brother Aban followed him soon after. Their father was furious and disowned them. Khalid emigrated to Abyssinia in the second migration with his wife Umaymah bint Khalaf, and they had children there.",
        "He returned with the Abyssinian migrants in 7 AH, after the Conquest of Khaybar, and settled in Madinah. He became one of the Prophet's scribes — recording correspondence and helping in the official administration. He also taught reading and writing to other Muslims, contributing to the literacy of the Madinan community.",
        "The Prophet ﷺ appointed him over the collection of zakat in Yemen, where he served until the Prophet's death.",
        "When the Ridda Wars settled and Abu Bakr turned attention to Sham, Khalid was among the first commanders sent. He led one of the early advance contingents into Roman territory. At the Battle of Marj al-Suffar, near Damascus, in 13 or 14 AH, he carried the Muslim standard and was killed in the fighting — making him one of the very first Companions martyred on the soil of Sham, opening the road that the great conquests would later complete.",
      ),
      legacy: p(
        "Khalid ibn Sa'id is one of the great early Companions whose name has slipped slightly out of popular memory but who is remembered in every classical Tabaqat work as one of the earliest converts, a scribe of the Prophet ﷺ, a teacher of writing, and a martyr at the gates of Sham.",
        "His story is a quiet reminder that the Prophet's correspondence was sustained by men whose names many Muslims today have not even heard. The Qur'an was preserved by famous scribes — but the wider written life of Madinah was supported by a circle of literate Companions like Khalid.",
        "His martyrdom on the road to Damascus also marks him as one of the small group of Companions who were the first seeds of Islam in Sham — a land that would become a great heart of the Ummah for centuries.",
      ),
      keyFacts: [
        "Among the first four or five men to embrace Islam in Makkah",
        "Beaten and disowned by his father al-As ibn Umayyah",
        "Emigrated to Abyssinia, returned to Madinah in 7 AH",
        "Served as one of the Prophet's scribes and teachers of writing",
        "Appointed over zakat in Yemen by the Prophet ﷺ",
        "Martyred at the Battle of Marj al-Suffar in 13–14 AH, opening Sham",
      ],
      lessons: p(
        "Family hostility is one of the oldest tests of Islam. Khalid was beaten and disowned by his own father, and he did not bend. If you face the same, you walk a path well-worn by giants.",
        "Literacy is service. Teaching another Muslim to read Qur'an, to write Arabic, to use writing for da'wah — this is the same line of work as the Companions who taught the people of Madinah how to write.",
        "Quiet service is still recorded with Allah. Khalid is not as famous as Zayd or Mu'awiyah, but Allah has recorded every letter he wrote and every step he took on the road to Marj al-Suffar.",
        "Be willing to be forgotten in this world. The reward is with Allah, not with the size of your name in books.",
        "Do not despise a small role on a great mission. Khalid was a scribe, a tax officer in Yemen, then a flag-bearer in Sham. Each role was a piece of building Islam.",
      ),
    },
  },
  {
  ...
  {
    id: "scribes-hudhayfah-ibn-utbah",
